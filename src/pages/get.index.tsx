...
export async function handleRequest(req: Request) {
    try {
        ...
        if (!userName) {
            ...
            headers.append("set-cookie", `user_name=${userName}; Max-Age=86400; HttpOnly; SameSite=Strict; Secure;`);
        }
        ...
        const jsUrl = getAssetUrl("dist/chat.js");
        const responseHtml = html
            .replace("{{ styles }}", stylesUrl)
            .replace("{{ js }}", jsUrl)
